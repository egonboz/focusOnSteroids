...
const NavBar: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 flex items-center align-middle justify-between px-6 py-2 bg-white dark:bg-neutral-800 shadow-md transition-all">
      <p className="text-lg font-bold text-gray-800 dark:text-white">FocusOnSteroids</p>
      <p className="text-3xl font-bold mr-22 text-gray-800 dark:text-white hidden sm:flex">Focus Session</p>
      <button
